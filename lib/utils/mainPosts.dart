      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            //       autoPlay: false,
            //     ),
            //     items: widget.imgUrls.map((imageUrl) {
            //       return Builder(
            ...
            //           child: Text(
            //               "${_currentImageIndex + 1}/${widget.imgUrls.length}"),
            //         ),
            //       ),
            //     ),
            //   ),
                                ...
                                child: SingleChildScrollView(
                                  child: Container(
                                    ...
                                    child: ListView(
                                      ...
                                      children: [
                                        comment(
                                          userName: "KhsuhalGoyal78743",
                                          comments: "I hate you",
                                        ),
                                        comment(
                                          userName: "Temp123",
                                          comments:
                                              "This is wonderfull, No matter what others says. ❤️ This is wonderfull, No matter what others says.",
                                        ),
                                        comment(
                                          userName: "TrustMeBro",
                                          comments: "LAMO!!, FCK YOU",
                                        ),
                                        comment(
                                          userName: "TrustMeBro",
                                          comments: "LAMO!!, FCK YOU",
